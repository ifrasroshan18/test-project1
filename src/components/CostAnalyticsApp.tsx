...
export default function CostAnalyticsApp() {
  ...
  // Legend payload for service pie (values + percentages)
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-8">
            <div className="bg-white rounded p-4 shadow" ref={lineRef as any}>
              ...
              <div className="mt-2 flex space-x-2">
                <button onClick={() => downloadCSV(aggregateByDate(data), "cost-by-date.csv")} className="px-3 py-1 bg-white text-black border rounded">
                  Export CSV
                </button>
            ...
            <div className="bg-white rounded p-4 shadow" ref={pieRef as any}>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  ...
                  <Legend {...({ payload: serviceLegendPayload } as any)} layout="vertical" align="right" verticalAlign="middle" wrapperStyle={{ fontSize: 12, color: "#000" }} />
                </PieChart>
              </ResponsiveContainer>
              <div className="mt-2 flex space-x-2">
                <button onClick={() => downloadCSV(aggregateByService(data), "cost-by-service.csv")} className="px-3 py-1 bg-white text-black border rounded">
                  Export CSV
                </button>
          ...
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="bg-white rounded p-4 shadow" ref={areaRef as any}>
              ...
              <div className="mt-2 flex space-x-2">
                <button onClick={() => downloadCSV(cumulativeByDate(data), "cumulative-cost.csv")} className="px-3 py-1 bg-white text-black border rounded">
                  Export CSV
                </button>
